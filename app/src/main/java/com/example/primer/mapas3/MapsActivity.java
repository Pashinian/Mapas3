...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback, ClasePeticion.IRellenarSpinner{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View.OnClickListener oyente_botton = new View.OnClickListener(){
        ...
        btn_mostrar.setOnClickListener(oyente_botton);
        ClasePeticion.pedirJSON(this);
    }

    private void motrarMarcador() {
        if(marcador != null){
            marcador.remove();
        }
        ...
        marcador = mMap.addMarker(opciones);
        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(posicion, 6));
